...
app.get('/api/tts', async (req, res) => {
  ...
  const VOICE_ID = 'XB0fDUnXU5powFXDhCwa'; // Charlotte - visejezicni glas
  ...
  try {
    ...
    // Fallback Google TTS
    try {
      const url = `https://translate.google.com/translate_tts?ie=UTF-8&tl=sr&client=tw-ob&q=${encodeURIComponent(text.substring(0,150))}`;
